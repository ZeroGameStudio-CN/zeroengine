...
namespace ZGS.DataToolkit.Editor
{
    public sealed class DataToolkitProjectProfile
    {
        public DataToolkitProjectProfile(
            ...
            IEnumerable<IDataToolkitHeaderActionProvider> headerActionProviders = null)
        {
            ...
            AssetInspectorProviders = (assetInspectorProviders ?? Array.Empty<IDataToolkitAssetInspectorProvider>())
                ...
                .OrderBy(provider => provider.Order)
                .ToArray();
            HeaderActionProviders = (headerActionProviders ?? Array.Empty<IDataToolkitHeaderActionProvider>())
                .Where(provider => provider != null)
                .OrderBy(provider => provider.Order)
                .ToArray();
        }
        ...
        public IReadOnlyList<IDataToolkitHeaderActionProvider> HeaderActionProviders { get; }
    }
}
