...
- Localized the Core Tools Dashboard module, sections, entry labels, descriptions, and tooltips to Simplified Chinese.
- Updated Dashboard/editor-ui dependencies to 3.1.1/1.1.1 without changing window menu paths.
