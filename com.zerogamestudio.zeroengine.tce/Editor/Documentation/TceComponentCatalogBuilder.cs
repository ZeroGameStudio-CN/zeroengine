...
namespace ZeroEngine.TCE.Editor
{
    ...
    {
        public TceComponentCatalogField(string name, Type fieldType, string typeName, string defaultValue, string description)
        {
        ...
        private static IReadOnlyList<TceComponentCatalogField> BuildFields(Type dataType, object instance)
        {
            return dataType
                ...
                .Select(field => new TceComponentCatalogField(
                    ...
                    field.GetCustomAttribute<TceFieldDocAttribute>()?.Description ?? string.Empty))
                .ToArray();
        }
