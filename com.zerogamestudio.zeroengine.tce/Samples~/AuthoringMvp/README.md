# TCE Authoring MVP Sample

This sample demonstrates the generic graph asset and editor route.
...
The sample uses only generic TCE components and does not reference POB, P5,
combat, card, inventory, buff, stat, projectile, room, weapon, save, or session
systems.
