...
namespace ZeroEngine.TCE
{
    ...
    [Serializable]
    [TceComponentDoc(TceComponentDocCategory.Condition, "Flag", "Checks a generic flag source.", "Use this condition when a project adapter exposes tags, facts, states, or flags through ITceFlagSource without coupling TCE to a project-specific model.")]
