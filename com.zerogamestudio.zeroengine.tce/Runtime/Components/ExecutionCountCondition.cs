...
namespace ZeroEngine.TCE
{
    ...
    [Serializable]
    [TceComponentDoc(TceComponentDocCategory.Condition, "Execution Count", "Limits how many accepted executions can pass.", "Use this condition for generic one-shot or limited-use rules. The count increments only after all conditions have passed.")]
