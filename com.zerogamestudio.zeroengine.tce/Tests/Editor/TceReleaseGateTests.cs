...
namespace ZeroEngine.TCE.Tests.Editor
{
    ...
    public sealed class TceReleaseGateTests
    {
        ...
        private const string ModSystemPackagePath = "Packages/com.zerogamestudio.zeroengine.modsystem";
        private const string ModSystemAsmdefPath = ModSystemPackagePath + "/Runtime/ZeroEngine.ModSystem.asmdef";
        ...
        public void PackageManifests_PinReleaseVersionsAndBridgeDependencies()
        {
            ...
            StringAssert.Contains(@"""com.zerogamestudio.zeroengine.modsystem"": ""0.1.0""", bridgePackage);
            StringAssert.DoesNotContain(@"""com.zerogamestudio.zeroengine"":", bridgePackage);
        ...
        public void AsmdefReleaseBoundary_KeepsCoreBridgeAndContractsSeparated()
        {
            ...
            string modSystemAsmdef = File.ReadAllText(ModSystemAsmdefPath);
            ...
            StringAssert.Contains(@"""ZeroEngine.ModSystem""", bridgeAsmdef);
            StringAssert.DoesNotContain(@"ZeroEngine.ModSystem.Contracts", bridgeAsmdef);
            StringAssert.Contains(@"""references"": []", modSystemAsmdef);
            ...
            AssertNoProjectGameplayReferences(modSystemAsmdef, "ModSystem asmdef");
        }
