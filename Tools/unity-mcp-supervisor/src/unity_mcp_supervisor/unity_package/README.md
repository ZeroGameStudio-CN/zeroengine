...
Formal projects install this package from a tested ZeroEngine commit compatible
with their `umcp` CLI. CLI-only fixes do not require updating this project pin:
