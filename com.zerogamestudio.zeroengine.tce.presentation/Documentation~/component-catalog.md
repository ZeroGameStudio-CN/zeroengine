...
- `Settings`: Visual playback settings including style, tint, duration, fade delay, fade duration, alpha curve, optional RGB tint fade, material override, sprite sorting override, sprite renderer color control, offset, direction, renderer tint property name, sprite/mesh main texture property name, and main texture copy policy.
