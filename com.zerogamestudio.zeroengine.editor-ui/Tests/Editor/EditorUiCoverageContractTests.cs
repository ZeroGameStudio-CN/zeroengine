...
namespace ZeroEngine.EditorUI.Tests
{
    public sealed class EditorUiCoverageContractTests
    {
        ...
        public void CoverageFixture_HasClosedUpstreamInventory()
        {
            ...
            Assert.That(document.records.Count(record => record.countsTowardModuleTotal), Is.EqualTo(29));
            ...
            Assert.That(document.records.Select(record => record.typeName).Distinct().Count(), Is.EqualTo(30));
