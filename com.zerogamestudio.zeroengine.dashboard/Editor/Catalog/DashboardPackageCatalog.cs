...
namespace ZeroEngine.Editor.Dashboard
{
    ...
    internal static class DashboardPackageCatalog
    {
        ...
        private static readonly DashboardKnownPackage[] KnownPackageArray =
        {
            ...
            new DashboardKnownPackage("com.zerogamestudio.zeroengine.autobattle", "自动战斗", "格子战术、编队与自动战斗框架。", false, true, "com.zerogamestudio.zeroengine.core", "com.zerogamestudio.zeroengine.combat", "com.zerogamestudio.zeroengine.data", "com.zerogamestudio.zeroengine.ai"),
            ...
            new DashboardKnownPackage("com.zerogamestudio.zeroengine.pvp", "异步 PvP", "队伍快照、匹配与排行框架。", false, true, "com.zerogamestudio.zeroengine.core", "com.zerogamestudio.zeroengine.autobattle"),
