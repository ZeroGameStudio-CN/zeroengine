...
2.0.1 的 Editor 面板使用 `com.zerogamestudio.zeroengine.editor-ui@1.3.0`。通过 Git URL 安装时，消费工程必须把 Analytics 与 editor-ui 直接 pin 到同一 ZeroEngine commit；Unity 2022.3 不会自动解析同仓 sibling package。
