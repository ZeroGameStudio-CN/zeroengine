...
namespace POB.Extraction
{
    ...
    public class ExtractionRaidSession
    {
        ...
        public ExtractionRaidRuleSnapshot RuleSnapshot;
        ...
        public bool TrySetRuleSnapshot(ExtractionRaidRuleSnapshot snapshot)
        {
            if (snapshot == null || snapshot.DurationSeconds <= 0 || RuleSnapshot != null)
                return false;
